...
public class EnrichingCatalystMenu extends AbstractContainerMenu {

    private final Level level;
    private final EnrichingCatalystBlockEntity entity;
    private final ContainerData data;

    public EnrichingCatalystMenu(int pContainerId, Inventory inv, FriendlyByteBuf reader) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(reader.readBlockPos()), new SimpleContainerData(2));
    }

    public EnrichingCatalystMenu(int pContainerId, Inventory inv, BlockEntity blockEntity, ContainerData data) {
        super(ModMenuTypes.ENRICHING_CATALYST_MENU.get(), pContainerId);
        checkContainerSize(inv, 4);
        this.level = inv.player.level;
        this.entity = (EnrichingCatalystBlockEntity) blockEntity;
        this.data = data;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, entity.getBlockPos()), pPlayer, ModBlocks.ENRICHING_CATALYST.get());
    }
